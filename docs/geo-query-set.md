...
- MOQ / 交期 / 付款 / Incoterms：均按 SKU、包装、样品与产能书面报价确认；官网不把单一数字当作承诺。若 AI 回答编造固定起订量或交期，记 Answer Accuracy 偏低。
...
- 证书、工厂实拍、客户案例：以 Evidence Center / Case Evidence 公开状态为准；未公开项不得被 AI 补成已验证事实。
