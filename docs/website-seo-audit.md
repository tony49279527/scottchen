...
Cloud Run 移动端 Lighthouse 基线：

| 指标 | 优化前 | 当前 | 建议目标 |
| --- | ---: | ---: | ---: |
| Performance | 60 | 92 | 90+ |
| First Contentful Paint | 3.6 秒 | 2.2 秒 | 小于 1.8 秒 |
| Largest Contentful Paint | 19.9 秒 | 2.3 秒 | 真实用户 P75 小于 2.5 秒 |
| Total Blocking Time | 50 毫秒 | 100 毫秒 | 小于 200 毫秒 |
| Cumulative Layout Shift | 0 | 0 | 小于 0.1 |
| Speed Index | 9.1 秒 | 5.0 秒 | 小于 3.4 秒 |
| 页面传输量 | 6,228 KiB | 约 546 KiB | 越低越好 |
