      ...
      <section className="py-20 bg-industry-slate-950 border-t border-b border-industry-slate-800/80">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 p-6 rounded-lg bg-industry-slate-950/80 border border-industry-slate-800 flex flex-col sm:flex-row items-center justify-between gap-4">
            <div>
              <h3 className="text-base font-bold text-white">Looking for complete abrasive specifications & custom assortments?</h3>
              <p className="text-xs text-industry-slate-400 mt-1">Browse all product lines, material options, MOQ guidelines and SKU-level packaging fields.</p>
            </div>
            <Link
              href="/products"
