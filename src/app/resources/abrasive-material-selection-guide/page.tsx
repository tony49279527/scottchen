...
export default function AbrasiveMaterialSelectionGuide() {
  const articleSchema = {
    ...
    dateModified: pageDateForPath("/resources/abrasive-material-selection-guide") ?? SITE_UPDATED,
      ...
      <section className="border-b border-industry-slate-800 bg-industry-slate-950 py-14">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-6 flex flex-wrap gap-x-6 gap-y-2 text-xs text-industry-slate-400">
            ...
            <span>Technical references reviewed {pageDateForPath("/resources/abrasive-material-selection-guide") ?? SITE_UPDATED}</span>
          </div>
        </div>
      </section>
