...
export default function AutomotivePolishingKitsPage() {
  const schema = {
    ...
    "@graph": [
      ...
      {
        "@type": "Product",
        "@id": absoluteUrl("/solutions/automotive-polishing-kits#product"),
        name: "Private-label automotive polishing kit",
        description: "Configurable B2B kit combining polishing wheels, compounds, adapters, abrasives and retail packaging for approved automotive restoration workflows.",
        brand: { "@type": "Brand", name: "SCOTTCHEN" },
        category: "Automotive polishing and surface finishing kits",
